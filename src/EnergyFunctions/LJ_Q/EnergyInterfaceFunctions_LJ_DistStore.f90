...
!=============================================================================
      contains
!=============================================================================      
      subroutine Detailed_ECalc_LJ_Q_DStore(E_T,rejMove)
...
!     in a given move.  
      subroutine Shift_ECalc_LJ_Q_DStore(E_Inter, E_Intra, disp, PairList, dETable, useIntra, rejMove, &
...
!=============================================================================      
      subroutine SwapIn_ECalc_LJ_Q_DStore(E_Inter, E_Intra, PairList, dETable, rejMove, &
                                               useInter, NeighborDetailsNew)
...
!     has been selected for removal.  
      subroutine SwapOut_ECalc_LJ_Q_DStore(E_Inter, E_Intra, nType, nMol, dETable, useInter)
      use Coords
      use CBMC_Variables, only: regrowType
!      use EnergyCriteria
      use EnergyTables, only: E_Strch_Diff, E_NBond_Diff, E_Tors_Diff, E_Bend_Diff, E_Inter_Diff
