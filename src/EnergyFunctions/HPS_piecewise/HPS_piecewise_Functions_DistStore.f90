...
!*********************************************************************************************************************
      module InterEnergy_HPS_piecewise_DistStore
      use VarPrecision
...
!====================================================================================== 
      ...
      use SimParameters, only: nMolTypes, NPART, distCriteria,minDistCriteria, kapa, Dist_Critr_sq
           ...
           do jMol = jMolMin,NPART(jType)
             ...
             do iAtom = 1,nAtoms(iType)
               ...
               do jAtom = 1,nAtoms(jType)        
                 ...
                 E_Ele = E_Ele + Ele
                 rPair(globIndx1, globIndx2)%p%E_Pair = Ele + HPS
      ...
      write(nout,*) "Wang–Frenkel Energy:", E_HPS
...
!======================================================================================      
      ...
      use ForceField, only: nAtoms, atomArray
      use ForceFieldPara_HPS_piecewise, only: eps_tab, q_Nonzero, q_tab, sigsq_tab, lambda_tab, cutoffNBsq_tab, rcutElecsq
...
!      integer, pointer :: oldIndx 
      ...
      real(dp) :: eps,sig_sq,q,lambda
      logical :: q_Nzero
      real(dp) :: HPS, LJ, Ele, x, E_New,E_PairOld, E_Old
      real(dp) :: E_Ele,E_HPS, rcutNBsq
...
!======================================================================================      
      ...
      use SimParameters, only: distCriteria, NPART, minDistCriteria, kapa, Dist_Critr_sq
      ...
      integer :: iPair
      integer :: iType, iMol, iAtom, iIndx, jType, jIndx, jMol, jAtom, kPair
      integer(kind=atomIntType) :: atmType1,atmType2
      integer :: gloIndx1, gloIndx2
      real(dp) :: r_sq, r
      real(dp) :: eps,sig_sq,q,lambda
      ...
      do iPair = 1, nNewDist
        ...
        if(iIndx .ne. jIndx) then
          ...
          dETable(iIndx) = dETable(iIndx) + HPS + Ele
          dETable(jIndx) = dETable(jIndx) + HPS + Ele
          newDist(iPair)%E_Pair = HPS + Ele
        endif 
      enddo
...
!======================================================================================      
      subroutine QuickNei_ECalc_Inter_HPS_piecewise(jType, jMol, rejMove)
