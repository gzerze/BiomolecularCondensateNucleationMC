...
!*********************************************************************************************************************
      module Pressure_HPS_piecewise
      use VarPrecision

      contains
!======================================================================================      
      subroutine Detailed_PCalc_HPS_piecewise(P_T)
!      use ParallelVar
...
!======================================================================================      
      subroutine Shift_PCalc_HPS_piecewise(P_Trial, disp)
...
!======================================================================================      
      pure subroutine SwapOut_PCalc_HPS_piecewise(iType, iMol, P_Trial)
      use ForceField, only: nAtoms, atomArray
      use ForceFieldPara_HPS_piecewise, only: eps_tab, q_Nonzero, q_tab, sigsq_tab, lambda_tab, cutoffNBsq_tab, rcutElecsq
      use Coords, only: Displacement,  molArray
      use SimParameters, only: nMolTypes, NPART, kapa
...
!======================================================================================      
      subroutine SwapIn_PCalc_HPS_piecewise(P_Trial)
      use ForceField, only: nAtoms, atomArray
      use ForceFieldPara_HPS_piecewise, only: eps_tab, q_Nonzero, q_tab, sigsq_tab, lambda_tab, cutoffNBsq_tab, rcutElecsq
